...
public class UpdateProductSpecificationInputValidator : AbstractValidator<UpdateProductSpecificationInput>
{
    public UpdateProductSpecificationInputValidator()
    {
        RuleFor(x => x.Label)
            .NotEmpty()
            .MaximumLength(128);
